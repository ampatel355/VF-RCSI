"""Run the ADX Trend Following strategy for the active ticker."""
...
def main() -> None:
    ...
    trades_df = run_strategy("adx_trend_following", df, ticker=current_ticker)
    save_trade_outputs(
        current_ticker=current_ticker,
        agent_name="adx_trend_following",
        trades_df=trades_df,
