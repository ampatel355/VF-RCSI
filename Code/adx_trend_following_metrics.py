"""Calculate trade-level metrics for the ADX Trend Following strategy."""
...
try:
    from adx_trend_following_agent import main as create_trades
    from strategy_metrics_common import create_and_save_metrics, resolve_data_clean_dir
except ModuleNotFoundError:
    from Code.adx_trend_following_agent import main as create_trades
...
def main() -> None:
    ...
    input_path = data_clean_dir / f"{ticker}_adx_trend_following_trades.csv"
    output_path = data_clean_dir / f"{ticker}_adx_trend_following_metrics.csv"
