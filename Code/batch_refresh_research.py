...
CORE_STEPS = [
    "features.py",
    "regimes.py",
    "trend_pullback_agent.py",
    "breakout_volume_momentum_agent.py",
    "mean_reversion_vol_filter_agent.py",
    "volatility_managed_tsmom_agent.py",
    "momentum_relative_strength_agent.py",
    "random_agent.py",
    "trend_pullback_metrics.py",
    "breakout_volume_momentum_metrics.py",
    "mean_reversion_vol_filter_metrics.py",
    "volatility_managed_tsmom_metrics.py",
    "momentum_relative_strength_metrics.py",
    "random_metrics.py",
    "buy_and_hold.py",
    "regime_analysis.py",
    "monte_carlo.py",
