"""Calculate trade-level metrics for the Connors RSI(2) Pullback strategy."""
...
try:
    from connors_rsi2_pullback_agent import main as create_trades
    from strategy_metrics_common import create_and_save_metrics, resolve_data_clean_dir
except ModuleNotFoundError:
    from Code.connors_rsi2_pullback_agent import main as create_trades
...
def main() -> None:
    ...
    input_path = data_clean_dir / f"{ticker}_connors_rsi2_pullback_trades.csv"
    output_path = data_clean_dir / f"{ticker}_connors_rsi2_pullback_metrics.csv"
