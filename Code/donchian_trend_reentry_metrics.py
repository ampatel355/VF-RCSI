"""Calculate trade-level metrics for the Donchian Trend Reentry strategy."""
...
try:
    from donchian_trend_reentry_agent import main as create_trades
    from strategy_metrics_common import create_and_save_metrics, resolve_data_clean_dir
except ModuleNotFoundError:
    from Code.donchian_trend_reentry_agent import main as create_trades
...
def main() -> None:
    ...
    input_path = data_clean_dir / f"{ticker}_donchian_trend_reentry_trades.csv"
    output_path = data_clean_dir / f"{ticker}_donchian_trend_reentry_metrics.csv"
