"""Calculate simple performance metrics for the mean-reversion agent."""
...
try:
    ...
    from mean_reversion_agent import main as create_trades
except ModuleNotFoundError:
    from Code.research_metrics import calculate_trade_level_return_ratio
    from Code.mean_reversion_agent import main as create_trades
...
def main() -> None:
    ...
    input_path = data_clean_dir / f"{ticker}_mean_reversion_trades.csv"
    output_path = data_clean_dir / f"{ticker}_mean_reversion_metrics.csv"

    # Load the trade data created by the mean-reversion agent.
