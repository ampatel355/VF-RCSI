"""Calculate trade-level metrics for the Momentum + Relative Strength strategy."""
...
try:
    from momentum_relative_strength_agent import main as create_trades
    from strategy_metrics_common import create_and_save_metrics, resolve_data_clean_dir
except ModuleNotFoundError:
    from Code.momentum_relative_strength_agent import main as create_trades
...
def main() -> None:
    ...
    input_path = data_clean_dir / f"{ticker}_momentum_relative_strength_trades.csv"
    output_path = data_clean_dir / f"{ticker}_momentum_relative_strength_metrics.csv"
