"""Calculate simple performance metrics for the trend-following agent."""
...
try:
    ...
    from trend_agent import main as create_trades
except ModuleNotFoundError:
    from Code.research_metrics import calculate_trade_level_return_ratio
    from Code.trend_agent import main as create_trades
...
def main() -> None:
    ...
    input_path = data_clean_dir / f"{ticker}_trend_trades.csv"
    output_path = data_clean_dir / f"{ticker}_trend_metrics.csv"

    # Load the trade data created by the trend-following agent.
