"""Calculate trade-level metrics for the Trend + Pullback strategy."""
...
try:
    ...
    from trend_pullback_agent import main as create_trades
except ModuleNotFoundError:
    from Code.strategy_metrics_common import create_and_save_metrics, resolve_data_clean_dir
    from Code.trend_pullback_agent import main as create_trades
...
def main() -> None:
    ...
    input_path = data_clean_dir / f"{ticker}_trend_pullback_trades.csv"
    output_path = data_clean_dir / f"{ticker}_trend_pullback_metrics.csv"
