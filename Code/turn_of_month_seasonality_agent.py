"""Run the Turn-of-Month Seasonality strategy for the active ticker."""
...
def main() -> None:
    ...
    trades_df = run_strategy("turn_of_month_seasonality", df, ticker=current_ticker)
    save_trade_outputs(
        current_ticker=current_ticker,
        agent_name="turn_of_month_seasonality",
        trades_df=trades_df,
