"""Calculate trade-level metrics for the Turn-of-Month Seasonality strategy."""
...
try:
    ...
    from turn_of_month_seasonality_agent import main as create_trades
except ModuleNotFoundError:
    from Code.strategy_metrics_common import create_and_save_metrics, resolve_data_clean_dir
    from Code.turn_of_month_seasonality_agent import main as create_trades
...
def main() -> None:
    ...
    input_path = data_clean_dir / f"{ticker}_turn_of_month_seasonality_trades.csv"
    output_path = data_clean_dir / f"{ticker}_turn_of_month_seasonality_metrics.csv"
