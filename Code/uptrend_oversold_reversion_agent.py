"""Run the Uptrend Oversold Reversion strategy for the active ticker."""
...
def main() -> None:
    ...
    trades_df = run_strategy("uptrend_oversold_reversion", df, ticker=current_ticker)
    save_trade_outputs(
        current_ticker=current_ticker,
        agent_name="uptrend_oversold_reversion",
        trades_df=trades_df,
