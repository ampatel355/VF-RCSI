"""Run the Volatility Squeeze Breakout strategy for the active ticker."""
...
def main() -> None:
    ...
    trades_df = run_strategy("volatility_squeeze_breakout", df, ticker=current_ticker)
    save_trade_outputs(
        current_ticker=current_ticker,
        agent_name="volatility_squeeze_breakout",
        trades_df=trades_df,
